...
@section('content')
    ...
    <section class="bg-[#210034] min-h-screen flex items-center justify-center text-white relative">
        <div class="container">
            {{-- card group 1 --}}
            <div class="flex flex-col gap-8 items-center justify-center z-20 md:flex-row scroll-animated">
            ...
            {{-- card group 2 --}}
            <div class="flex flex-col gap-8 items-center justify-center z-20 md:flex-row my-10 scroll-animated">
                <div class="max-w-sm bg-black bg-opacity-40 border border-gray-800 rounded-xl shadow dark:bg-gray-800 dark:border-gray-700">
                ...
                @foreach ($comments as $item)
                    <article class="my-9 text-white" data-comment-id="{{ $item->id }}">
                        ...
                        <div class="flex flex-col">
                            ...
                            <div class="">
                                {{-- Form untuk balasan --}}
                                <form id="reply-form-{{ $item->id }}" action="{{route('blog.comment.reply')}}" method="POST" class="hidden mt-3">
                                    @csrf
