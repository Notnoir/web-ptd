...
@section('content')
    <section class="bg-gradient-to-b from-[#11001B] to-[#3f007d] min-h-screen flex items-center justify-center">
        ...
        <div class="border border-[#11001B] bg-[#11001B] text-white p-10 rounded-xl relative -top-5 lg:w-96 w-72">
            ...
            <div class="flex flex-col mt-10">
                ...
                <!-- Modal toggle -->
                <button data-modal-target="default-modal" data-modal-toggle="default-modal" class="block text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mt-8" type="button">
                    Edit Profile
                </button>
